...
Module.register("customclock", {
	...
	getDom: function () {
		...
		// Style Wrappers
		dateWrapper.className = "date bright medium custom-date-font-size";
		timeWrapper.className = "time bright large light custom-time-font-size";
